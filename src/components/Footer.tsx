          ...
          <div className="lg:col-span-1">
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3 text-gray-400">
                ...
                <a href="mailto:support@novapexhub.com" className="hover:text-[#00C08B] transition-colors duration-200">
                  support@novapexhub.com
                </a>
              </div>
              <div className="flex items-center space-x-3 text-gray-400">
                <Mail className="h-4 w-4" />
                <a href="mailto:contact@novapexhub.com" className="hover:text-[#00C08B] transition-colors duration-200">
                  contact@novapexhub.com
                </a>
              </div>
              <div className="flex items-center space-x-3 text-gray-400">
                <Phone className="h-4 w-4" />
                <a href="tel:+912269718996" className="hover:text-[#00C08B] transition-colors duration-200">
                  +91 22 6971 8996
                </a>
              </div>
              <div className="flex items-center space-x-3 text-gray-400">
